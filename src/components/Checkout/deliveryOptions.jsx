 ...
 },
{
 ...
 function calculateDeliveryDate(deliveryOption){
  ...
  return (
    <div>
     <h2 className='flex relative cursor-pointer text-lg pb-2 md:text-2xl'>
      Delivery Options 
    </h2>
     {
      deliveryOptions.map(deliveryOption => {
       ...
       return(
        ...
        className={`shadow-xl rounded-lg p-5 mb-3 cursor-pointer md:w-full md:text-2xl md:rounded-xl  lg:text-lg lg:w-3/4 border border-grayish-blue ${isChecked(deliveryOption.id) ? 'bg-orange text-light-grayish-blue' : 'bg-white'}  transition transition-300 hover:bg-orange/50 hover:text-black`}>
